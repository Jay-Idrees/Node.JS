...
- Express is all about middleware. A middleware is a set of functions that are applied to an incoming request. The result is a response or passing on to another middleware
