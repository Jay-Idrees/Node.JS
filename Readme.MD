...
- It handles creation of servers behind the scenes. The requests to and from the server are then handled with middleware that can perform actions on incoming/outgoing requests according to needs
