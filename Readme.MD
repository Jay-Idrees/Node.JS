# Node.JS and Express.JS for MERN (MongoDb, Express.JS, React, Node.JS) Stack
...
- Install with :
- `npm init`
- `npm install express --save` Here `--save` refers to core only dependency or `--save-dev` only for saving as a developement dependency